...
class SignupViewController: NANavigationViewController {
    ...
    @IBAction func signup_BtnSignup(_ sender: Any) {
        ...
        if profileImage.image == #imageLiteral(resourceName: "signUpProfileIcon") {
        ...
        if profileImage.image != #imageLiteral(resourceName: "signUpProfileIcon") && !(signup_TxtFullName.text?.isEmpty)! && isEmailAddressIsValid == true {
