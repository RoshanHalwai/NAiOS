...
struct Constants {
    ...
    static let FIREBASE_GLOBAL_USERDATA_CABS = GlobalUserData.shared.getUserDataReference().child(Constants.FIREBASE_CHILD_CABS)
    ...
    static let FIREBASE_GLOBAL_USERDATA_DELIVERIES = GlobalUserData.shared.getUserDataReference().child(Constants.FIREBASE_CHILD_DELIVERIES)
    
    static let FIREBASE_VISITORS_PRIVATE =
        Constants.FIREBASE_DATABASE_REFERENCE.child(Constants.FIREBASE_CHILD_VISITORS)
            .child(Constants.FIREBASE_CHILD_PRIVATE)
    
     static let FIREBASE_VISITORS_ALL = FIREBASE_DATABASE_REFERENCE.child(Constants.FIREBASE_CHILD_VISITORS).child(Constants.FIREBASE_USER_CHILD_ALL)
    
    static let FIREBASE_GLOBAL_USERDATA_VISITORS = GlobalUserData.shared.getUserDataReference()
        .child(Constants.FIREBASE_CHILD_VISITORS)
    
    static let FIREBASE_GLOBAL_USERDATA_DAILY_SERVICES = GlobalUserData.shared.getUserDataReference()
    ...
    static let FIREBASE_DAILY_SERVICES_ALL_PRIVATE = Constants.FIREBASE_DATABASE_REFERENCE.child(Constants.FIREBASE_CHILD_DAILY_SERVICES).child(Constants.FIREBASE_USER_CHILD_ALL).child(Constants.FIREBASE_CHILD_PRIVATE)
    
    static let FIREBASE_USER_PRIVATE = FIREBASE_DATABASE_REFERENCE.child(FIREBASE_USER)
        .child(FIREBASE_CHILD_PRIVATE)
    
    static let FIREBASE_USER_ALL = FIREBASE_DATABASE_REFERENCE.child(Constants.FIREBASE_USER).child(Constants.FIREBASE_USER_CHILD_ALL)
    
    static let FIREBASE_EMERGENCY_PRIVATE_ALL = FIREBASE_DATABASE_REFERENCE.child(Constants.FIREBASE_CHILD_EMERGENCY).child(Constants.FIREBASE_CHILD_PRIVATE).child(Constants.FIREBASE_USER_CHILD_ALL)
    
    static let FIREBASE_EMERGENCY_PUBLIC = FIREBASE_DATABASE_REFERENCE.child(Constants.FIREBASE_CHILD_EMERGENCY).child(Constants.FIREBASE_USER_PUBLIC)
    
    static let FIREBASE_GLOBAL_USERDATA_FLAT_MEMBERS =  GlobalUserData.shared.getUserDataReference().child(Constants.FIREBASE_CHILD_FLATMEMBERS)
    
    static let FIREBASE_GLOBAL_USERDATA_GATE_NOTIFICATIONS = GlobalUserData.shared.getUserDataReference().child(Constants.FIREBASE_CHILD_GATE_NOTIFICATION)
}
