...
struct Constants {
    ...
    static let FIREBASE_EVENT_MANAGEMENT = FIREBASE_DATABASE_REFERENCE.child(Constants.FIREBASE_CHILD_EVENT_MANAGEMENT)
    
    static let FIREBASE_VEHICLES_PRIVATE = FIREBASE_DATABASE_REFERENCE.child(Constants.FIREBASE_CHILD_VEHICLES).child(Constants.FIREBASE_CHILD_PRIVATE)
    
    static let FIREBASE_VEHICLES_ALL = FIREBASE_DATABASE_REFERENCE.child(Constants.FIREBASE_CHILD_VEHICLES).child(Constants.FIREBASE_USER_CHILD_ALL)
    
    static let FIREBASE_GUARD_PRIVATE_DATA = FIREBASE_DATABASE_REFERENCE.child(Constants.FIREBASE_CHILD_GUARD).child(Constants.FIREBASE_CHILD_PRIVATE).child(Constants.FIREBASE_CHILD_DATA)
}
